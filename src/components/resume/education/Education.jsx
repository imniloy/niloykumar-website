...
const Education = ({ info }) => {
  ...
  return (
    <motion.div
      ...
      className="acheivement-item group z-0 pl-6 border-l-[5px] border-[#1b1b11] relative before:content-['']  before:absolute  before:h-5 before:w-5 before:border-[5px] before:border-[#1b1b11] before:bg-background2 before:hover:bg-[#009e66] before:z-[1] before:left-0 before:rounded-full before:-translate-x-[60%]  before:transition-all before:duration-[400ms] before:mt-11"
    >
      {/*  */}

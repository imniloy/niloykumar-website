...
const Education = ({ info }) => {
  ...
  return (
    <motion.div
      ...
      className="education-item group z-0 basis-1/2 pl-6 border-l-[5px] border-[#1b1b11] relative before:content-['']  before:absolute  before:h-5 before:w-5 before:border-[5px] before:border-[#1b1b11] before:bg-background2 before:hover:bg-[#009e66] before:z-[1] before:left-0 before:rounded-full before:-translate-x-[60%]  before:transition-all before:duration-[400ms] before:mt-11"
    >
      {/*  */}
      <div className="px-7 xl:px-10 py-8 xl:py-11 text-lightn font-poppins bg-background1 group-hover:bg-none group-hover:bg-[#191b1e] shadow-shadow1 transition-all duration-[400ms] before:content-[''] before:absolute before:left-0 before:h-[6px] before:w-[32px] -z-10 before:mt-2 before:bg-[#1b1b11]">

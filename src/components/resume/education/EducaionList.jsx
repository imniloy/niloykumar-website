...
const EducaionList = () => {
  ...
  return (
    <div className="mt-10 sm:mt-14 mx-2 500px:mx-4 sm:mx-8 lg:mx-4 xl:mx-2 flex flex-col space-y-10 lg:space-y-0 lg:flex-row justify-between items-center gap-x-10">

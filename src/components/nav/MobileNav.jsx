        ...
        <div className="w-[320px] sm:w-[375px] overflow-x-hidden p-3 font-poppins">
          ...
          <div className=" my-5 ">
            <ul>
              ...
              <li className="mobile-nav-menu-item">About Me</li>
              <li className="mobile-nav-menu-item">SKILLS</li>
              <li className="mobile-nav-menu-item">SERVICES</li>
              <li className="mobile-nav-menu-item">PROJECTS</li>
              <li className="mobile-nav-menu-item">BLOGS</li>
              <li className="mobile-nav-menu-item">CONTRACT</li>
            </ul>
          </div>

          {/* Social Media */}
          <div className="mt-24 mb-10 border-t border-[#6f797571]">

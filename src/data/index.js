export const resumeSection = {
  ...
  educationRelatedInfo: [
    ...
    {
      program: "Think in a redux-way | Batch 2",
      oraganization: "Learn With Sumit (2023)",
      description:
        "In this course i have learned redux, react-redux, redux-toolkit, redux-thunk, RTK Query and reselect library and i was the top student in this course.",
      result: "5/5",
    },
  ],
  professionalSkills: [
